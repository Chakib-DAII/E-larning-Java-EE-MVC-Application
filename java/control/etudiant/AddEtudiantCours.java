 ...
 * @author Chakib
 */
public class AddEtudiantCours extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            //if(test != null)
                EtudiantInscritCours etudiantCours = new EtudiantInscritCours( idcours,login);
                etudiantInscritCoursFacade.create(etudiantCours);
                
            List<Cours> coursUser = new ArrayList();
            
            List<EtudiantInscritCours> etCours=etudiantInscritCoursFacade.findAll();
            for(int i=0;i<etCours.size()-1;i++)
