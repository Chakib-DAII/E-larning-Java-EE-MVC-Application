 ...
 * @author Chakib
 */
@WebServlet(name = "AddChapitre", urlPatterns = {"/AddChapitre"})
@MultipartConfig(fileSizeThreshold=1024*1024*2, // 2MB
                 maxFileSize=1024*1024*10,      // 10MB
                 maxRequestSize=1024*1024*50)   // 50MB
public class AddChapitre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            int id = chapitre1.size()+1;
            String nom =request.getParameter("nom");
            String username = System.getProperty("user.name"); 
            System.out.println("\n\n\nusername : "+username+"\n\n\n");
            String savePath ="C:/Users/"+username+"/Documents/NetBeansProjects/E-Learning/ressources/cours/"+cours1.get(idc).getNom()+"/"+nom /*appPath + File.separator + SAVE_DIR*/;
